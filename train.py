...
class Unet(object):
	...
	def __init__(self):
		...
		self.validation_img_path = 'data/validation/images'
		self.validation_mask_path = 'data/validation/masks'
...
if __name__ == '__main__':
	...
	"""Please select appropriae statements to train or generate outputs"""
